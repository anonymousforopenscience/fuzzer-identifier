...
# All models available in the zenodo repository require to be uploaded on huggingface and value of the below variable `PATH_HUGGINGFACE` updated accordingly (currently not done to preserve anonymity)
PATH_HUGGINGFACE = "HUGGINGFACE_USERNAME/HUGGINGFACE_REPONAME"
